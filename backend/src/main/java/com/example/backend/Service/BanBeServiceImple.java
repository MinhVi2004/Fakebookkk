...
public class BanBeServiceImple implements BanBeService {
  ...
  // // Nếu trạng thái là "Đã Đồng Ý", không cho phép gửi lại yêu cầu
  // if (friendRequest.getTrangThaiBB().equals("Đã Đồng Ý")) {
  // throw new RuntimeException("Hai người đã là bạn bè. Không thể gửi lại yêu cầu
  // kết bạn.");
  // }

  // // Nếu trạng thái là "Chờ Chấp Nhận", không cho phép gửi lại yêu cầu
  // if (friendRequest.getTrangThaiBB().equals("Chờ Chấp Nhận")) {
  // throw new RuntimeException("Yêu cầu kết bạn đang chờ xử lý. Không thể gửi
  // lại.");
  // }
